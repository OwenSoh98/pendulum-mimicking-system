...
/**
 * Create a new FastPID controller with the given parameters.  Internally, this
 ...
 * rate in hz. Returns false if a configuration error has occurred.
 */
...
/**
 * Test for a configuration error. The controller will not run if this
